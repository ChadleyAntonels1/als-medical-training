  ...
  return (
    <div className=' text-center lg:text-start my-10 '>
      ...
      <div className='text-black bg-white font-medium w-full'>
        <div className=' relative justify grid grid-cols-2 mb-20 mx-12 md:mx-14 lg:mx-16 '>
          <div className=' grid col-span-2 lg:col-span-1'>
            <div className=' flex flex-col justify-center items-center'>
                <p className='text-[12px] md:text-[14px] lg:text-[16px] max-w-[500px] font-quattrocento-sans-regular py-16 pr-4'>
      ...
      {/* courses */}
      <div className='bg-rose-200 relative font-medium mx-12 md:mx-14 lg:mx-16'>
      <h1 className='text-[20px] md:text-[24px] font-quattrocento-regular font-semibold text-center mb-10'>
        ...
        <div className=' grid grid-cols-3 gap-10'>
          ...
          <div className=' grid col-span-3 justify-center items-center mb-20'>
            <button className='shadow-[inset_0px_0px_3px_3px] shadow-rose-200/80 bg-rose-300 px-3 py-1 rounded-lg font-quattrocento-sans-regular font-semibold text-[14px] md:text-[16px]'>
